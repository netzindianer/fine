...
class f_c_helper_wash
{
    ...
    public function utfGeneral($sString)
    {
        ...
        return str_replace(
            array(
                ...
                'ą', 'ć', 'ę', 'ł', 'ń', 'ó', 'ś', 'ź', 'ż', 'Ą', 'Ć', 'Ę', 'Ł', 'Ń', 'Ó', 'Ś', 'Ź', 'Ż',
                // other
                'Ð', 'ð', 'À', 'à', 'Â', 'â', 'Ã', 'ã', 'Å', 'å', 'Æ', 'æ', 'Ç', 'ç', 'È', 'è', 'Ê', 'ê', 'Ë', 'ë', 'Ì', 'ì', 'Î', 'î', 'Ï', 'ï', 'Ñ', 'ñ', 'Ò', 'ò', 'Õ', 'õ', 'Ø', 'ø',
                'Ù', 'ù', 'Û', 'û', 'Þ', 'þ'
            ), 
            array(
                // cyrylica
                ...
                'a', 'c', 'e', 'l', 'n', 'o', 's', 'z', 'z', 'A', 'C', 'E', 'L', 'N', 'O', 'S', 'Z', 'Z',
                // other
                'D', 'o', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'C', 'c', 'E', 'e', 'E', 'e', 'E', 'e', 'I', 'i', 'I', 'i', 'I', 'i', 'N', 'n', 'O', 'o', 'O', 'o', 'O', 'o',
                'U', 'u', 'U', 'u', 'B', 'b', 
            ),
            $sString);
    }
