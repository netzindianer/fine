...
class f_m implements IteratorAggregate, Countable
{
      ...
      /**
       * Ustala lub pobiera alias tabeli w zależności od parametru
       *
       * @param string|null $sAlias Alias tabeli
       * @return string|$this Alias tabeli
       */
      public function alias($sAlias = null)
      {
          if (func_num_args() == 0) {
              return $this->_alias;
          }
